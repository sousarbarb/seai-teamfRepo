...
<table class="tab">
<tr><td class="gg">
Entity Name: </td><td><input type="text" name="entity" value="<?php echo $entity;?>">
...
<tr><td>
Official Representative: </td><td><input type="text" name="official" value="<?php echo $official;?>">
  <span class="error"><?php echo $offErr;?></span></td>
</tr>
<tr><td>
E-mail: </td><td><input type="text" name="mail2" value="<?php echo $mail2;?>">
  <span class="error"><?php echo $mail2Err;?></span></td>
</tr>
<tr><td>
Phone Number: </td><td><input type="text" name="phone2" value="<?php echo $phone2;?>">
